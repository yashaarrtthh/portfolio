...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:${personalInfo.emails.primary}?subject=Portfolio Inquiry&body=Hello ${personalInfo.firstName},%0D%0A%0D%0AI came across your portfolio and would like to connect with you.%0D%0A%0D%0ABest Regards,`;
